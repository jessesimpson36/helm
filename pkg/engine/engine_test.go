...
func TestNestedHelpersProducesMultilineStacktraceDivideByZero(t *testing.T) {
	c := &chart.Chart{
		Metadata: &chart.Metadata{Name: "NestedHelperFunctions"},
		Templates: []*chart.File{
			{Name: "templates/svc.yaml", Data: []byte(
			...
			{Name: "charts/common/templates/_helpers_2.tpl", Data: []byte(
				`{{- define "common.names.get_name" -}}{{- div 42 0 -}}{{- end -}}`,
			)},
		},
	}
...
NestedHelperFunctions/templates/_helpers_1.tpl:1:39
  executing "nested_helper.name" at <include "common.names.get_name" .>:
    error calling include:
NestedHelperFunctions/charts/common/templates/_helpers_2.tpl:1:42
  executing "common.names.get_name" at <div 42 0>:
    error calling div: runtime error: integer divide by zero`
